...
# ==========================================
# 0. I MIGLIORI IPERPARAMETRI (Da Optuna)
# ==========================================
BEST_HIDDEN_CHANNELS = 64
BEST_NUM_LAYERS = 2
BEST_DROPOUT = 0.2096
BEST_LR = 0.00242
BEST_WEIGHT_DECAY = 0.004
BEST_MARGIN = 0.5
BEST_K_NEGATIVES = 3

NUM_EPOCHS = 300 # Lasciamo un numero alto, l'Early Stopping ci protegge
...
for libro_chunks in biblioteca:
    ...
    df_libro = sampler.generate_dataset(k_negatives=BEST_K_NEGATIVES) 
...
idx_to_node = {v: k for k, v in node_to_idx.items()} # Dizionario inverso utile per dopo
