import os
import time
from model.micro import processa_libro_intero
from model.macro import fondi_sub_grafi_dinamico
from model.export import esporta_per_embedding
from dotenv import load_dotenv # <-- Aggiungi questa importazione
import anthropic
...
def main():
    ...
    file_input = "book/DrJekyllAndMrHyde.txt"
    cartella_json = "sub_grafi_output"
    file_output_tsv = "JekyllHyde.tsv"
    ...
    processa_libro_intero(file_input) 
    ...
    grafo_globale = fondi_sub_grafi_dinamico(cartella_json)
